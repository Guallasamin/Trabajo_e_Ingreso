...
########################################################################
#### Proyecto:Caída de la participación del trabajo en el ingreso
#### Documento: Caída de la participación del trabajo en el ingreso
...
dir_output <- "outputpublico/"
dir_output_2<- "bases_peq/"
